...
users = {}
texts_literal = {
        'DISCLAIMER': 'Отлично!\n\nМы хотим показать вам 6 рисунков и узнать, что вы думаете по поводу того, что на '
                      'них изображено. На рисунках вы увидите людей, которые участвуют в переговорной деятельности.'
                      ' Глядя на рисунки, вы наверняка определите, что они делают, о чем думают, что чувствуют.'
                      ' Наверняка вы можете вспомнить о сходных ситуациях, в которых вам уже пришлось побывать.\n\n'
                      'В таких ситуациях можно чувствовать себя по-разному. Можно заниматься делом охотно или без '
                      'желания. Можно радоваться и чувствовать себя счастливым или испытывать неуверенность в том, '
                      ...
                      ' небольшой рассказ.\n\nМы же поступим проще. Вам не надо будет рассказывать никаких историй.\n\n'
                      '<i>Нужно будет лишь найти из приложенного списка те предложения, которые подходят к тому или '
                      'иному рисунку.</i>\n\n<b>Точность результатов зависит от того, насколько откровенны вы будете.'
                      ' Пожалуйста, отвечайте как чувствуете, а не обдумывая, какой ответ будет признан правильным.</b>',
